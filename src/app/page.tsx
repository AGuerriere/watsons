...
export default function Home() {
  ...
  const apiKey = process.env.PUBLIC_ACCESS_KEY || "72eabd82-8da4-48ff-8ec9-26e5b706b153";

  const { submit: onSubmit } = useWeb3Forms({
    access_key: apiKey,
    settings: {
      from_name: "Watsons Opticians",
        ...
        <div id="contact-us" className="mb-10 2xl:w-[1600px]">
          ...
          <div className='flex lg:flex-row flex-col'>
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col mb-10">
                ...
                <div className="mb-3">
                  <input
                    ...
                    className="bg-grey3 h-16 pl-5 w-full rounded border mb-3 placeholder:text-grey4"
            ...
            <div className='flex flex-col lg:ml-20'>
              ...
              <h4 className='text-2xl font-normal text-black mt-5'>Ballycastle</h4>
